            ...
            projects: [
                {
                    ...
                    date: "2025",
                    description: "Challenge: High manual bottlenecks and error rates when verifying complex API contracts across QA releases.",
                    icon: <Code size={20} />,
                    details: [
                        "Solution: Developed a custom Python-based semantic diffing engine that automatically compares Swagger YAML versions, intelligently parsing imports and endpoints.",
                        "Impact: Packaged the utility as a Maven plugin and integrated it directly into the CI/CD pipeline, effectively eliminating manual errors and boosting overall QA testing efficiency by 80%.",
                        "Leveraged Agentic AI for making this poc possible within a 2 day window. Created own plan .md's and context .md's."
                    ]
                },
                {
                    id: "devbot",
                    ...
                    date: "2023",
                    description: "Solution: Developed a Bash script to fully automate local environment setup and manage Tomcat start/stop lifecycles.",
                    icon: <Terminal size={20} />,
                    details: [
                        "Impact: Adopted by 16+ developers, replacing manual configuration steps and saving approximately 2 hours of setup time per developer, per sprint."
                    ]
                },
                {
                    id: "hackathons",
                                                ...
                                                <ul className="timeline-details-list">
                                                    {project.details.map((detail, dIndex) => (
                                                        <li key={dIndex} className="timeline-detail-item">
                                                            <strong>{detail.split(':')[0]}{detail.includes(':') ? ':' : ''}</strong>
